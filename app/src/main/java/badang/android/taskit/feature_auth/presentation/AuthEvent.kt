...
sealed class AuthEvent {
    ...
    data class SignUp(val email: String, val password: String, val name: String, val confirm: String) :
        AuthEvent()

    data class ResetPassword(val password: String, val confirm: String) : AuthEvent()
